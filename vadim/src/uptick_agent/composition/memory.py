...
# Keep the historical qualified names in any diagnostics or serialized model
# metadata while the implementation lives behind the composition boundary.
OfflineSmokeResult.__module__ = "uptick_agent.experimental_runtime"
ExperimentalMemoryRuntime.__module__ = "uptick_agent.experimental_runtime"
