...
class MemoryConfiguration(ContractModel):
    ...
    It is intentionally not consumed by AgentRunner yet.  Stage 3 owns module
    construction, approvals verification, diagnostics and context budgeting.
    """
    ...
    compatibility_legacy: ModuleConfig = Field(
        default_factory=lambda: ModuleConfig(enabled=True, version="legacy-1.0")
    )
